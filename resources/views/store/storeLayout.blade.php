...
<body>
    ...
    <header>
        <!-- TOP HEADER -->
        <div id="top-header" style="background-color:pink">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +000-00-00-10</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> support@smartstore.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i>Syria Aleppo</a></li>
                </ul>
                <ul class="header-links pull-right">
                
                    @if(session()->has('user'))
                      <li><a style="color:green" href="{{route('user.history')}}">{{session()->get('user')->full_name}} </a></li>  
    ...
    <footer id="footer" >
                    ...
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Aleppo Syria</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>+963-2222222</a></li>
        ...
        <!-- bottom footer -->
        <div id="bottom-footer" class="section" style="background-color:pink">
            <div class="container">
                <!-- row -->
                <div class="row">
